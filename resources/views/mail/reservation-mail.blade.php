<div class="email-card">
    <div>
        ...
        <ul>
            ...
            @endif
            @if(isset($data["apartment_title"]))
                <li>
                    <span>Title :</span> {{$data["apartment_title"]}}
                </li>
            @endif
            @if(isset($data["apartment_type"]))
                <li>
                    <span>Type :</span> {{$data["apartment_type"]}}
                </li>
            @endif
            @if(isset($data["apartment_city"]))
                <li>
                    <span>City :</span> {{$data["apartment_city"]}}
                </li>
            @endif
            @if(isset($data["apartment_address"]))
                <li>
                    <span>Address :</span> {{$data["apartment_address"]}}
                </li>
            @endif
            @if(isset($data["apartment_price"]))
                <li>
                    <span>Price :</span> {{$data["apartment_price"]}}
                </li>
            @endif
            @if(isset($data["phone"]))
                <li>
...
<style>
    ...
    :is(.dark div.email-card > div > h5) {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-white) / var(--tw-text-opacity));
    }

    div.email-card > div > p {
        font-weight: var(--tw-font-weight-normal);
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-700) / var(--tw-text-opacity));
    }

    :is(.dark div.email-card > div > p) {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-400) / var(--tw-text-opacity));
    }

    div.email-card > div > ul {
        max-width: var(--tw-width-md);
    }

    div.email-card > div > ul > :not([hidden]) ~ :not([hidden]) {
        --tw-space-y-reverse: 0;
        margin-top: calc(var(--tw-size-1) * calc(1 - var(--tw-space-y-reverse)));
        margin-bottom: calc(var(--tw-size-1) * var(--tw-space-y-reverse));
    }
    ...
    :is(.dark div.email-card > div > ul) {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-400) / var(--tw-text-opacity));
    }

    div.email-card > div > ul > li > span {
        font-weight: var(--tw-font-weight-semibold);
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-900) / var(--tw-text-opacity));
    }

    :is(.dark div.email-card > div > ul > li > span) {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-white) / var(--tw-text-opacity));
    }
