            ...
            <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                    ...
                    <div class="mt-6 sm:mt-8 lg:mt-0">
                        ...
                        <span
                            class="bg-primary-100 text-primary-800 text-xs font-medium capitalize px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{$apartment->city}}</span>

                        <p class="my-6 text-xl text-gray-500 dark:text-gray-400">
                            {{$apartment->address}}
                        </p>
