            ...
            <div class="flex items-center lg:space-x-2">
                @auth
                    ...
                    <div id="userDropdown1"
                         class="hidden z-[35] w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow-xl dark:divide-gray-600 dark:bg-gray-700">
...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="{{route("home")}}" class="hover:underline">Harry-NB</a>
                        </li>
                        <li>
                            <a href="{{route("home")}}" class="hover:underline">Tailwind CSS</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="{{route("home")}}" class="hover:underline ">Github</a>
                        </li>
                        <li>
                            <a href="{{route("home")}}" class="hover:underline">Discord</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="{{route("home")}}" class="hover:underline">Privacy Policy</a>
                        </li>
                        <li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2077 <a href="{{route("home")}}"
                                                                                            class="hover:underline">Harry-NB™</a>. All Rights Reserved.
            </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="{{route("home")}}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
