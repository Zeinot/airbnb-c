...
@section('content')
                    ...
                    <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                        <div
                            ...
                            <div
                                ...
                                <h2 class="mb-3 text-3xl font-extrabold leading-none text-white lg:text-5xl">Save today on
                                    your new iMac computer.</h2>
                                <p class="mb-5 text-gray-200">Reserve your new Apple iMac 27” today and enjoy exclusive
                                    savings. Pre-order now to secure your discount.</p>
                                <a href="#"
                                    class="inline-flex rounded-lg bg-primary-700 px-5 py-3 text-base font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300">Pre-order
                                    now</a>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    ...
                                    arrival</span>
                                <h2 class="mb-3 text-3xl font-extrabold leading-none text-white lg:text-5xl">New arrivals
                                    picked just for you</h2>
                                <p class="mb-5 text-gray-200">Less is more never out of date.</p>
                                <div class="flex items-center">
                                    <a href="#"
                                        class="me-3 inline-flex rounded-lg bg-primary-700 px-5 py-3 text-base font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300">Discover
                                        more</a>
                                    <a href="#"
                    ...
                    <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                        <div
                            ...
                            <div
                                ...
                                <h2 class="mb-3 text-3xl font-extrabold leading-none text-white lg:text-5xl">Gamers’
                                    Favorites. Best Sellers.</h2>
                                <p class="mb-5 text-gray-200">The world's largest retail gaming and trade-in destination for
                                    Xbox, PlayStation, and Nintendo games, systems, consoles & accessories.</p>
                                <a href="#"
    ...
    {{-- Image with CTA button# --}}
    {{-- Tailwind CSS Customer Logos - Flowbite --}}
    <section class="bg-white dark:bg-gray-900">
