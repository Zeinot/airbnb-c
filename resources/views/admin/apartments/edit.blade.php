        ...
        <div
            ...
            <form id="createForm" class="space-y-6" method="POST" action="{{route("apartments.store")}}"
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" @if(old("title")) value="{{old('title')}}" @else value="{{$apartment->title}}" @endif
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="city" id="city" @if(old("city")) value="{{old('city')}}" @else value="{{$apartment->city}}" @endif
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                               placeholder="City ..."/>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price
                            ($)</label>
                        <input type="number" name="price" id="price" @if(old("price")) value="{{old('price')}}" @else value="{{$apartment->price}}" @endif
