...
@section("content")
    ...
    <div class="rounded-lg border-gray-300 dark:border-gray-600 mb-4">
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form id="createForm" class="space-y-6" method="POST" action="{{route("reservations.store")}}">
                @csrf
                <h5 class="text-xl font-medium text-gray-900 dark:text-white">Create Reservation</h5>
                
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="apartment_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apartment</label>
